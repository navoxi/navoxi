navoxi.config(['$translateProvider', function($translateProvider) {
    $translateProvider.translations('fr-FR', {
    	...
    	'NOTIFICATIONS_RADIO_WAYDOWN': 'Avertissement à la descente',
    	'NOTIFICATIONS_RADIO_DURINGTRANSFER': 'En station',
    ...
    $translateProvider.translations('en', {
    	...
    	'NOTIFICATIONS_RADIO_WAYDOWN': 'Way down warning',
    	'NOTIFICATIONS_RADIO_DURINGTRANSFER': 'In station',
